...
### PBMC AFA models
PBMC_AFA_model_geuvadis_ALL_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_AFA_R2_-1_model_geuvadis_ALL_expression_spearman_correlation.txt",header=T)
PBMC_AFA_model_geuvadis_CEU_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_AFA_R2_-1_model_geuvadis_CEU_expression_spearman_correlation.txt",header=T)
PBMC_AFA_model_geuvadis_FIN_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_AFA_R2_-1_model_geuvadis_FIN_expression_spearman_correlation.txt",header=T)
PBMC_AFA_model_geuvadis_GBR_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_AFA_R2_-1_model_geuvadis_GBR_expression_spearman_correlation.txt",header=T)
PBMC_AFA_model_geuvadis_TSI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_AFA_R2_-1_model_geuvadis_TSI_expression_spearman_correlation.txt",header=T)
PBMC_AFA_model_geuvadis_YRI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_AFA_R2_-1_model_geuvadis_YRI_expression_spearman_correlation.txt",header=T)

PBMC_ALL_model_geuvadis_ALL_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_ALL_R2_-1_model_geuvadis_ALL_expression_spearman_correlation.txt",header=T)
PBMC_ALL_model_geuvadis_CEU_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_ALL_R2_-1_model_geuvadis_CEU_expression_spearman_correlation.txt",header=T)
PBMC_ALL_model_geuvadis_FIN_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_ALL_R2_-1_model_geuvadis_FIN_expression_spearman_correlation.txt",header=T)
PBMC_ALL_model_geuvadis_GBR_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_ALL_R2_-1_model_geuvadis_GBR_expression_spearman_correlation.txt",header=T)
PBMC_ALL_model_geuvadis_TSI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_ALL_R2_-1_model_geuvadis_TSI_expression_spearman_correlation.txt",header=T)
PBMC_ALL_model_geuvadis_YRI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_ALL_R2_-1_model_geuvadis_YRI_expression_spearman_correlation.txt",header=T)

PBMC_CAU_model_geuvadis_ALL_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CAU_R2_-1_model_geuvadis_ALL_expression_spearman_correlation.txt",header=T)
PBMC_CAU_model_geuvadis_CEU_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CAU_R2_-1_model_geuvadis_CEU_expression_spearman_correlation.txt",header=T)
PBMC_CAU_model_geuvadis_FIN_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CAU_R2_-1_model_geuvadis_FIN_expression_spearman_correlation.txt",header=T)
PBMC_CAU_model_geuvadis_GBR_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CAU_R2_-1_model_geuvadis_GBR_expression_spearman_correlation.txt",header=T)
PBMC_CAU_model_geuvadis_TSI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CAU_R2_-1_model_geuvadis_TSI_expression_spearman_correlation.txt",header=T)
PBMC_CAU_model_geuvadis_YRI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CAU_R2_-1_model_geuvadis_YRI_expression_spearman_correlation.txt",header=T)

PBMC_CHN_model_geuvadis_ALL_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CHN_R2_-1_model_geuvadis_ALL_expression_spearman_correlation.txt",header=T)
PBMC_CHN_model_geuvadis_CEU_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CHN_R2_-1_model_geuvadis_CEU_expression_spearman_correlation.txt",header=T)
PBMC_CHN_model_geuvadis_FIN_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CHN_R2_-1_model_geuvadis_FIN_expression_spearman_correlation.txt",header=T)
PBMC_CHN_model_geuvadis_GBR_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CHN_R2_-1_model_geuvadis_GBR_expression_spearman_correlation.txt",header=T)
PBMC_CHN_model_geuvadis_TSI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CHN_R2_-1_model_geuvadis_TSI_expression_spearman_correlation.txt",header=T)
PBMC_CHN_model_geuvadis_YRI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_CHN_R2_-1_model_geuvadis_YRI_expression_spearman_correlation.txt",header=T)

PBMC_HIS_model_geuvadis_ALL_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_HIS_R2_-1_model_geuvadis_ALL_expression_spearman_correlation.txt",header=T)
PBMC_HIS_model_geuvadis_CEU_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_HIS_R2_-1_model_geuvadis_CEU_expression_spearman_correlation.txt",header=T)
PBMC_HIS_model_geuvadis_FIN_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_HIS_R2_-1_model_geuvadis_FIN_expression_spearman_correlation.txt",header=T)
PBMC_HIS_model_geuvadis_GBR_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_HIS_R2_-1_model_geuvadis_GBR_expression_spearman_correlation.txt",header=T)
PBMC_HIS_model_geuvadis_TSI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_HIS_R2_-1_model_geuvadis_TSI_expression_spearman_correlation.txt",header=T)
PBMC_HIS_model_geuvadis_YRI_Exp<-fread("" %&% dir %&% "PBMC/spearman/PBMC_HIS_R2_-1_model_geuvadis_YRI_expression_spearman_correlation.txt",header=T)
...
ggsave("PBMC_AFA_model_geuvadis_estimated_spearman_violin.png",width=12,height=7)
...
ggplot(data=ALL_Model_Exp_Correlations, aes(x=ID,y=estimate,fill=ID)) + geom_violin() + geom_boxplot(width=violin_boxplot_width)  +
  ...
  guides(fill = guide_legend(title="Geuvadis Populations")) + xlab("Geuvadis Populations") + ylab("Estimated Spearman Correlation Coefficient") +
  scale_fill_manual(values = color)
ggsave("PBMC_ALL_model_geuvadis_estimated_spearman_violin.png",width=12,height=7)
...
ggplot(data=CAU_Model_Exp_Correlations, aes(x=ID,y=estimate,fill=ID)) + geom_violin() + geom_boxplot(width=violin_boxplot_width)  +
  ...
  guides(fill = guide_legend(title="Geuvadis Populations")) + xlab("Geuvadis Populations") + ylab("Estimated Spearman Correlation Coefficient") +
  scale_fill_manual(values = color)
ggsave("PBMC_CAU_model_geuvadis_estimated_spearman_violin.png",width=12,height=7)
...
ggplot(data=CHN_Model_Exp_Correlations, aes(x=ID,y=estimate,fill=ID)) + geom_violin() + geom_boxplot(width=violin_boxplot_width)  +
  ...
  guides(fill = guide_legend(title="Geuvadis Populations")) + xlab("Geuvadis Populations") + ylab("Estimated Spearman Correlation Coefficient") +
  scale_fill_manual(values = color)
ggsave("PBMC_CHN_model_geuvadis_estimated_spearman_violin.png",width=12,height=7)
...
ggplot(data=HIS_Model_Exp_Correlations, aes(x=ID,y=estimate,fill=ID)) + geom_violin() + geom_boxplot(width=violin_boxplot_width)  +
  ...
  guides(fill = guide_legend(title="Geuvadis Populations")) + xlab("Geuvadis Populations") + ylab("Estimated Spearman Correlation Coefficient") +
  scale_fill_manual(values = color)
ggsave("PBMC_HIS_model_geuvadis_estimated_spearman_violin.png",width=12,height=7)
