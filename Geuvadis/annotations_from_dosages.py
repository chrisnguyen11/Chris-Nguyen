...
for chromNumber in range(1, 23):
    print(str(chromNumber))
    dosageFile = open(pop + ".chr" + str(chromNumber) + ".maf0.01.R20.8.dosage.txt", "r")
    annoFile = open("pred_db_anno_hg38.chr" + str(chromNumber) + ".maf0.01.dosage.txt", "w")
    genoFile = open("pred_db_geno_hg38.chr" + str(chromNumber) + ".maf0.01.dosage.txt", "w")
